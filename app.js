...
app.get("/", function(req,res){
  res.render("home", {para1: homeStartingContent, homePosts: posts});
});
...
app.get("/posts/:test", function(req, res){
  posts.forEach(function(post){
    if(_.lowerCase(post.postTitle) === _.lowerCase(req.params.test)){
      //console.log(post.postTitle + " " + post.postBody);
      res.render("post", {lctitle: _.lowerCase(post.postTitle),posttitle: post.postTitle, postbody: post.postBody});
    }
  });
});
